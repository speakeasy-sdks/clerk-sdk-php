...
class OAuthApplication
{
    ...
    #[\JMS\Serializer\Annotation\Type('enum<Clerk\Backend\Models\Components\OAuthApplicationObject>')]
    ...
    {
        $this->object = \Clerk\Backend\Models\Components\OAuthApplicationObject::OauthApplication;
        $this->id = '';
        $this->instanceId = '';
        $this->name = '';
        $this->clientId = '';
