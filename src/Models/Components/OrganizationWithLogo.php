...
class OrganizationWithLogo
{
    ...
    #[\JMS\Serializer\Annotation\Type('enum<Clerk\Backend\Models\Components\OrganizationWithLogoObject>')]
    ...
    {
        $this->object = \Clerk\Backend\Models\Components\OrganizationWithLogoObject::Organization;
        $this->id = '';
        $this->name = '';
        $this->slug = '';
        ...
        $this->publicMetadata = new \Clerk\Backend\Models\Components\OrganizationWithLogoPublicMetadata();
        $this->privateMetadata = new \Clerk\Backend\Models\Components\OrganizationWithLogoPrivateMetadata();
        $this->createdBy = null;
        $this->createdAt = 0;
        $this->updatedAt = 0;
        $this->logoUrl = null;
