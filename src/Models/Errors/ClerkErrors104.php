...
/** ClerkErrors104 - Request was not successful */
class ClerkErrors104
{
    /**
     * $errors
     *
    ...
    public function toException(): ClerkErrors104Throwable
    {
        $serializer = Utils\JSON::createSerializer();
        $message = $serializer->serialize($this, 'json');
        $code = -1;

        return new ClerkErrors104Throwable($message, (int) $code, $this);
    }
}