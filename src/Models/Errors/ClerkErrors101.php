...
/** ClerkErrors101 - Payment required */
class ClerkErrors101
{
    /**
     * $errors
     *
    ...
    public function toException(): ClerkErrors101Throwable
    {
        $serializer = Utils\JSON::createSerializer();
        $message = $serializer->serialize($this, 'json');
        $code = -1;

        return new ClerkErrors101Throwable($message, (int) $code, $this);
    }
}