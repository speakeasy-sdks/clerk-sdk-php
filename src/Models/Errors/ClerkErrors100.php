...
/** ClerkErrors100 - Payment required */
class ClerkErrors100
{
    /**
     * $errors
     *
    ...
    public function toException(): ClerkErrors100Throwable
    {
        $serializer = Utils\JSON::createSerializer();
        $message = $serializer->serialize($this, 'json');
        $code = -1;

        return new ClerkErrors100Throwable($message, (int) $code, $this);
    }
}