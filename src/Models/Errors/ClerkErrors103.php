...
/** ClerkErrors103 - Payment required */
class ClerkErrors103
{
    /**
     * $errors
     *
    ...
    public function toException(): ClerkErrors103Throwable
    {
        $serializer = Utils\JSON::createSerializer();
        $message = $serializer->serialize($this, 'json');
        $code = -1;

        return new ClerkErrors103Throwable($message, (int) $code, $this);
    }
}