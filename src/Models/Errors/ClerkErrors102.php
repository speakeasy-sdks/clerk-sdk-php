...
/** ClerkErrors102 - Payment required */
class ClerkErrors102
{
    /**
     * $errors
     *
    ...
    public function toException(): ClerkErrors102Throwable
    {
        $serializer = Utils\JSON::createSerializer();
        $message = $serializer->serialize($this, 'json');
        $code = -1;

        return new ClerkErrors102Throwable($message, (int) $code, $this);
    }
}